                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: sel ? AppColors.studentColor : AppColors.background,
                        borderRadius: BorderRadius.circular(20),
                        border: Border.all(
                            color: sel ? AppColors.studentColor : AppColors.divider),
                      ),
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: _selectedClass == 'All'
                ? FirebaseFirestore.instance.collection('students')
                    .where('approvalStatus', isEqualTo: 'approved').snapshots()
                : FirebaseFirestore.instance.collection('students')
                    .where('approvalStatus', isEqualTo: 'approved')
                    .where('className', isEqualTo: _selectedClass).snapshots(),
            builder: (ctx, snap) {
              ...
              var students = docs.map((d) =>
                  StudentModel.fromMap(d.data() as Map<String, dynamic>)).toList();
                ...
                Container(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.poppins(fontSize: 13,
                        color: AppColors.studentColor, fontWeight: FontWeight.w600),
                  ),
                ),
...
class _StudentCard extends StatelessWidget {
  ...
  Color get _classColor {
    ...
    if (c == 'Nursery' || c == 'LKG' || c == 'UKG') return const Color(0xFF059669);
    if (c.contains('1') || c.contains('2') || c.contains('3')) return const Color(0xFF2563EB);
    if (c.contains('4') || c.contains('5') || c.contains('6')) return const Color(0xFF7C3AED);
    if (c.contains('7') || c.contains('8') || c.contains('9')) return const Color(0xFFD97706);
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              _chip('Roll ${student.rollNumber}', AppColors.textSecondary),
            ]),
